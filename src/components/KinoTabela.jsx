...
const KenoTable = memo(function KenoTable({ drawData, drawId, last, snapshot, language }) {
  var takenAt = null;
  ...
  return (
    <div className="bg-blue-950 p-3 flex flex-col w-10/12 md:w-1/2 mx-auto rounded-md relative shadow-lg shadow-blue-900 zoom opacity-[20%] scale-[0.9]">
      ...
      {last && <p className="text-center text-xs font-mont select-none text-green-300">{language === "en" ? "LAST DRAW" : "POSLEDNJE IZVUČENO"}</p>}
